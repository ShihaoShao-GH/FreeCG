...
from freecg import datasets, models, priors
from freecg.data import DataModule
from freecg.models import output_modules
from freecg.models.utils import act_class_mapping, rbf_class_mapping
from freecg.module import LNNP
from freecg.utils import LoadFromCheckpoint, LoadFromFile, number, save_argparse
import pickle
...
def get_args():
    ...
    parser.add_argument('--derivative', default=False, action="store_true", help='If true, take the derivative of the prediction w.r.t coordinates')
    ...
    parser.add_argument('--standardize', action="store_true", default=False, help='If true, multiply prediction by dataset std and add mean')
    ...
    parser.add_argument('--model', type=str, default='FreeCGBlock', choices=models.__all__, help='Which model to train')
    ...
    parser.add_argument('--equivariant-output', action="store_true", default=True, help='If true, use equivariant output head (this option does not affect the equivariance of the model)')
    ...
    parser.add_argument('--trainable-rbf', action="store_true", default=False, help='If distance expansion functions should be trainable')
    ...
    parser.add_argument('--trainable-vecnorm', action="store_true", default=False, help='If vector normalization should be trainable')
    ...
    parser.add_argument('--num-groups', type=int, default=32, help='Number of groups')
    parser.add_argument('--num-edges-eachgroup', type=int, default=8, help='Number of edges each group')
    ...
    parser.add_argument('--redirect', action="store_true", default=False, help='Redirect stdout and stderr to log_dir/log')
